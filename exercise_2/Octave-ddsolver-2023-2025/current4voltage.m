...
%                         Gummel iterations
%          
%          ini_profile .. output profiles to be used as initial guess
%
...
take_prevguess = itercontrol.prev_guess;

if ((nargin == 4)&&(itercontrol.prev_guess))
  disp('Initial guess missing... use thermal equilibrium');
  take_prevguess = false;  
endif
...
if (exist("ini_profile","var")) 
  profile = initial_guess(take_prevguess,voltage, device, temperature, ini_profile);
else
  profile = initial_guess(take_prevguess,voltage, device, temperature);
endif;
...
% Descaling procedure + set output profiles
